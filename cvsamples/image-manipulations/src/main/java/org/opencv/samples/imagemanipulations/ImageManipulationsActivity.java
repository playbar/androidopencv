...
public class ImageManipulationsActivity extends Activity implements CvCameraViewListener2 {
    ...
    {
        super.onResume();
        if(PermissionUtils.checkPermission( ImageManipulationsActivity.this,new String[]{Manifest.permission.CAMERA,Manifest.permission.WRITE_EXTERNAL_STORAGE},200)) {
