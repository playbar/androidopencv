package org.opencv.samples.puzzle;
...
public class Puzzle15Activity extends Activity implements CvCameraViewListener, View.OnTouchListener {
    ...
    {
        super.onResume();
        if(PermissionUtils.checkPermission( Puzzle15Activity.this,new String[]{Manifest.permission.CAMERA,Manifest.permission.WRITE_EXTERNAL_STORAGE},200)) {
